...
public class MainActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // 1. Initialize AdMob & Banner (Visible at the Top)
        ...
        // 2. FLOW: Show Interstitial immediately on App Open
        ...
        // 4. JavaScript Bridge for Downloads & Ad Triggering
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onShowFileChooser(WebView w, ValueCallback<Uri[]> f, FileChooserParams p) {
                ...
                // ✅ Fixes "No PDF Header" by allowing multiple files for Merge PDF
        ...
        InterstitialAd.load(this, INTERSTITIAL_ID, new AdRequest.Builder().build(),
            new InterstitialAdLoadCallback() {
                ...
                public void onAdLoaded(@NonNull InterstitialAd ad) {
                    mInterstitialAd = ad;
                    mInterstitialAd.show(MainActivity.this); // Show on Open
                    loadInterstitialOnly(); // Load next for download click
                }
                @Override
    ...
    private void injectGlobalListener() {
        String js = "javascript:(function() {" +
                ...
                "    " +
                "    // Show Ad on any click containing 'download' or 'generate'" +
